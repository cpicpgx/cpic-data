...
update pair set guidelineid=(select id from guideline where name='CYP2C19 and Proton Pump Inhibitors'), usedforrecommendation=true where drugid='RxNorm:816346' and genesymbol='CYP2C19';
update pair set guidelineid=(select id from guideline where name='CYP2C19 and Proton Pump Inhibitors'), usedforrecommendation=true where drugid='RxNorm:17128' and genesymbol='CYP2C19';
update pair set guidelineid=(select id from guideline where name='CYP2C19 and Proton Pump Inhibitors'), usedforrecommendation=true where drugid='RxNorm:7646' and genesymbol='CYP2C19';
update pair set guidelineid=(select id from guideline where name='CYP2C19 and Proton Pump Inhibitors'), usedforrecommendation=true where drugid='RxNorm:40790' and genesymbol='CYP2C19';
